...
#'
#' @return An object of class `ber_diag`: a list with components
#'   \describe{
...
#' @export
#' @examples
#' diag <- ber_diagnostics(sim_nc$logRr, sim_nc$seLogRr,
#'                         ncNames = sim_nc$outcome)
#' diag
ber_diagnostics <- function(ncLogRr, ncSeLogRr, ncNames = NULL) {
